...
long long xmltol(XMLCSTR t,long long v) {
	if (t&&(*t)) return _wtoi64(t);
	return v;
}
double    xmltof(XMLCSTR t,double    v) {
	if (t&&(*t)) swscanf(t, L"%lf", &v); /*v=_wtof(t);*/ return v;
}
#else
#ifdef sun
// for CC
...
#ifdef _XMLWINDOWS
long long xmltol(XMLCSTR t,long long v) {
	if (t&&(*t)) return _atoi64(t);
	return v;
}
#else
long long xmltol(XMLCSTR t,long long v) {
	if (t&&(*t)) return atoll(t);
	return v;
}
#endif
char      xmltob(XMLCSTR t,char      v) {
...
// You should normally not change object below this point.
